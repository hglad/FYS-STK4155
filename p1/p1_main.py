...
"""
def main(dataset='Franke',n=50,method='ols'):
    np.random.seed(6)
    # np.random.seed(10)
    ...
    if (dataset == 'Franke'):
        ...
        # CI for beta
        CI(beta, np.sqrt(var_beta), n, p=5)
    ...
    if (method == 'ols'):
        best_poly = np.argmin(MSE_test[:,0])
    ...
    plot_mse_train_test(polys, MSE_test, MSE_train, params, n)
